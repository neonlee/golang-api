...
func (r *categoryRepository) Create(categoria *models.CategoriaProduto) error {
	return r.connection.Create(categoria).Error
}

func (r *categoryRepository) GetByID(id uint) (*models.CategoriaProduto, error) {
...
func (r *categoryRepository) Update(categoria *models.CategoriaProduto) error {
	return r.connection.Save(categoria).Error
}

func (r *categoryRepository) Delete(id uint) error {
	return r.connection.Delete(&models.CategoriaProduto{}, id).Error
}

func (r *categoryRepository) ListByEmpresa(empresaID uint) ([]models.CategoriaProduto, error) {
...
func (r *categoryRepository) GetWithProdutos(id uint) (*models.CategoriaProduto, error) {
	var categoria models.CategoriaProduto
